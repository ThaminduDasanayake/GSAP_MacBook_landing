...
const performanceImgPositions = [
    {
        ...
        tablet: {left: 30, bottom: 50},
        mobile: {left: 35, bottom: 52},
    },
    {
        id: "p2",
        desktop: {right: 10, bottom: 60},
        tablet: {right: 30, bottom: 50},
        mobile: {right: 35, bottom: 52},
    },
    {
        id: "p3",
        desktop: {right: -5, bottom: 35},
        tablet: {right: 28, bottom: 30},
        mobile: {right: 29, bottom: 18},
    },
    {
        id: "p4",
        desktop: {right: -10, bottom: 0},
        tablet: {right: 28, bottom: -5},
        mobile: {right: 35, bottom: -15},
    },
    {
        id: "p5",
        desktop: {left: 20, bottom: 50},
        tablet: {left: 15, bottom: 40},
        mobile: {left: 10, bottom: 30},
    },
    {
        id: "p6",
        desktop: {left: 0, bottom: 30},
        tablet: {left: 25, bottom: 25},
        mobile: {left: 29, bottom: 18},
    },
    {
        id: "p7",
        desktop: {left: -5, bottom: 0},
        tablet: {left: 28, bottom: 0},
        mobile: {left: 35, bottom: -15},
    },
];
